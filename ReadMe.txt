...
<html>
  <head>       
   <h1> Facebook.v2 tutorial <h1/>
     ...
     <h2>Best practice<h2/>
       <p> -Try not to take any code as copy-paste here is like a helper to you.</p> 
       <p> -Please make sure to try it yourself first.</p>
         <h3> Used Libraries</h3>
       <p>
         <a href="https://firebase.google.com/docs/auth/"> - firebase Authentication</a></p>
     <a href="https://firebase.google.com/docs/firestore"> - firebase cloud database</a></p>
       <p><a href= "https://developer.android.com/kotlin/coroutines?gclid=Cj0KCQjwl8anBhCFARIsAKbbpyRu5ItsW2yKnUoQ1eGEwCA-L9l40Mps5JMdjhT_NjClLL5Dml3mPI8aAhkwEALw_wcB&gclsrc=aw.ds">-Coroutines</a></p>
